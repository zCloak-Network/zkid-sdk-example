...
const attest = async (serverMsg: Message<MessageType>, num: number, deputy_num: number) => {
  ...
  if (sendRes.status === 200) {
    console.log(`SUCCESS_${num}.${deputy_num}: send encrypted message to server, claim has already attested.`);
  } else {
